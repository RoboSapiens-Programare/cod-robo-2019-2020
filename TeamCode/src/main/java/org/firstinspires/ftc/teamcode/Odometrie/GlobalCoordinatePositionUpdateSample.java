...
//For some reason asta e busit desi imi si spune ca e unused so?????
import org.firstinspires.ftc.teamcode.Odometrie.OdometryGlobalCoordinatePosition;
...
public abstract class GlobalCoordinatePositionUpdateSample extends RobotHardware {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        such that when the MotorVerticalLeft and MotorVerticalRight encoders spin forward, they return positive values, and when the
        MotorHorizontal encoder travels to the right, it returns positive value
        */
